...
class ATCClassicLandingScreenViewController: UIViewController {
    ...
    private let backgroundColor: UIColor = .orange
    private let tintColor: UIColor = .gray
    ...
    @IBAction func newslide(_ sender: Any) {
    ...
    override func viewDidLoad() {
        ...
        logoImageView.image = UIImage.localImage("logo")
        

        titleLabel.font = titleFont
        titleLabel.text = "Good Samaritan SF"
